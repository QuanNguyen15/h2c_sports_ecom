                                ...
                                <div class="product">
                                    <figure class="product-media">
                                        <a href="{{ route('user.product-sidebar', $product->id) }}">
                                            <img src="{{ url('assets/images/productImages/' . $product->image) }}" alt="Product image" class="product-image">
                                        </a>

                                        <div class="product-action-vertical">
                                            <!-- Add to wishlist button or other actions -->
                                        </div><!-- End .product-action -->

                                        <div class="product-action action-icon-top">
                                            <a href="{{ route('user.product-sidebar', $product->id) }}" class="btn-product btn-cart"><span>Xem chi tiết</span></a>
                                            <!-- Other actions like quick view, compare, etc. -->
                                        </div><!-- End .product-action -->
                                    </figure><!-- End .product-media -->

                                    <div class="product-body">
                                        <div class="product-cat">
                                            <a href="#">{{ $product->categoryID }}</a> <!-- Assuming you have category data -->
                                        </div><!-- End .product-cat -->
                                        <h3 class="product-title"><a href="{{ route('user.product-sidebar', $product->id) }}">{{ $product->name }}</a></h3><!-- End .product-title -->
