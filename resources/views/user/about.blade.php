                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="brands-text">
                                <h2 class="title">Điểm đến hội tụ nhiều cái tên thương hiệu và các câu lạc bộ hàng đầu thế giới</h2><!-- End .title -->
                                <p>Tại H2C Sport, chúng tôi tự hào là điểm đến đa dạng và phong phú, cung cấp những sản phẩm chất lượng từ các thương hiệu uy tín nhất trên thị trường. Từ Adidas, Nike, Puma đến các câu lạc bộ hàng đầu như Manchester United, Barcelona, ​​Real Madrid và nhiều hơn nữa, chúng tôi đảm bảo có đủ mọi lựa chọn để đáp ứng nhu cầu và sở thích của mọi khách hàng. Hãy ghé thăm cửa hàng của chúng tôi ngay hôm nay để khám phá bộ sưu tập đa dạng và đẳng cấp của chúng tôi!</p>
                            </div><!-- End .brands-text -->
                        </div><!-- End .col-lg-5 -->
                        <div class="col-lg-7">
                                ...
                                <figure class="member-media">
                                    ...
                                    <figcaption class="member-overlay">
                                        <div class="member-overlay-content">
                                            <h3 class="member-title">Nguyễn Đức Hùng<span>Founder & CEO</span></h3><!-- End .member-title -->
                                            <p>Hùng, Founder và CEO của H2C Sport, là một người đam mê bóng đá với sứ mệnh mang đến trải nghiệm mua sắm chất lượng và đa dạng nhất cho các fan bóng đá.</p>
