...
<head>
    ...
    <!-- Font-icon css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('layoutAdmin/main.css') }}">
</head>
<body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header">
        <a class="app-header__logo" href="{{ route('admins.thongke') }}"></a>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu settings-menu dropdown-menu-right">
                    ...
                    <li>
                        ...
                        <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('logoutForm').submit();"><i class="fa fa-sign-out fa-lg"></i>Đăng xuất</a>
                    </li>
                </ul>
            </li>
        </ul>
    ...
    <aside class="app-sidebar">
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item" href="{{ route('admins.categories') }}"><span class="app-menu__label">Quản lí danh mục sản phẩm</span></a></li>
            <li><a class="app-menu__item" href="{{ route('admins.product') }}"><span class="app-menu__label">Quản lí sản phẩm</span></a></li>
            <li><a class="app-menu__item" href="{{ route('admins.account') }}"><span class="app-menu__label">Quản lí tài khoản</span></a></li>
